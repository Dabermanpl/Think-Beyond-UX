...
export function Hero() {
  return (
    <section id="hero" className="relative pt-[132px] md:pt-[164px] pb-24 md:pb-32 px-6 overflow-hidden bg-white">
      {/* Background Decor */}
      ...
      <div className="max-w-7xl mx-auto grid lg:grid-cols-2 gap-12 md:gap-20 items-center relative z-10">
        <div className="space-y-10 relative z-10">
          ...
          <div className="hidden md:flex flex-wrap gap-4">
            <Link 
              href="#contact" 
              className="bg-black text-white px-8 py-4 rounded-full font-bold shadow-xl hover:bg-zinc-800 transition-all flex items-center justify-center gap-3 group/btn"
            >
              Darmowa konsultacja
        ...
        <div className="relative group z-10 flex justify-center">
          <div className="relative w-full max-w-[600px]">
            ...
            <div className="relative aspect-[4/3] bg-zinc-50 rounded-[32px] border-2 border-zinc-100 p-2 shadow-2xl transition-transform group-hover:scale-[1.02] duration-500 overflow-hidden">
            ...
            <div className="absolute -top-6 -left-6 bg-white p-4 rounded-2xl border border-zinc-100 shadow-xl flex items-center gap-4 animate-bounce-subtle z-20">
            ...
            <div className="absolute -bottom-6 -right-6 bg-white p-4 rounded-2xl border border-zinc-100 shadow-xl flex items-center gap-4 animate-bounce-subtle-delayed z-20">
            ...
            {/* Avatar 1: Agata W. */}
            <div className="absolute top-[15%] left-0 translate-x-1/4 flex flex-col items-start animate-float pointer-events-none z-30">
              ...
              <div className="bg-white border border-zinc-100 p-3 rounded-2xl rounded-tl-none shadow-xl max-w-[150px] -mt-1 ml-3">
                <p className="text-[10px] text-zinc-600 leading-snug font-medium">
            ...
            {/* Avatar 2: Kamila D. */}
            <div className="absolute top-[60%] right-0 -translate-x-1/4 flex flex-col items-end animate-float-delayed pointer-events-none z-30">
              ...
              <div className="bg-white border border-zinc-100 p-3 rounded-2xl rounded-tr-none shadow-xl max-w-[150px] -mt-1 mr-3">
                <p className="text-[10px] text-zinc-600 leading-snug font-medium">
