...
import { X, ArrowRight, Phone, Mail, Linkedin, Users } from "lucide-react";
    ...
    <div className="fixed inset-0 z-[200] flex items-center justify-center p-4 md:p-6 overflow-y-auto">
      ...
      <div className="relative z-50 w-full max-w-5xl bg-white rounded-[40px] shadow-2xl overflow-hidden animate-in zoom-in-95 duration-300 pointer-events-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 min-h-[500px]">
            ...
            <div className="space-y-8">
              ...
              <form className="space-y-5" onSubmit={(e) => e.preventDefault()}>
                ...
                <div className="flex items-start gap-3 py-1">
                  ...
                  <label htmlFor="modal-gdpr" className="text-[10px] text-zinc-500 leading-normal cursor-pointer select-none">
                    Akceptuję <a href="/polityka-prywatnosci" className="underline hover:text-black transition-colors">politykę prywatności</a>.
                  </label>
                </div>

                <button 
                  type="submit"
                  className="w-full py-4 bg-black text-white rounded-full font-bold shadow-lg hover:bg-zinc-800 hover:translate-y-[-2px] transition-all flex items-center justify-center gap-2 group"
                >
                  <span className="text-sm">Umów darmową konsultację</span>
          ...
          {/* Right Side: Direct Contact Card (Trust-Building) */}
          <div className="bg-zinc-50 p-8 md:p-12 flex flex-col justify-center space-y-10">
            <div className="space-y-6">
              ...
              <div className="flex items-center gap-6">
                <div className="w-20 h-20 bg-white rounded-full flex items-center justify-center text-zinc-300 border border-zinc-100 shadow-sm overflow-hidden relative ring-4 ring-zinc-100/50">
                  ...
                  <div className="absolute inset-0 flex items-center justify-center text-[8px] font-bold uppercase tracking-tighter text-zinc-400 text-center px-1 bg-zinc-100/90 leading-tight">
                    [Expert Photo]
                  </div>
                </div>
                <div>
            ...
            <div className="space-y-4">
              ...
              >
                ...
                <span className="font-body font-bold text-zinc-700 text-sm">+48 502 227 174</span>
              </a>
            ...
            <a 
              ...
              className="flex items-center justify-center gap-2 py-4 px-6 rounded-2xl border border-zinc-200 bg-white font-bold text-sm text-zinc-600 hover:bg-zinc-50 transition-all shadow-sm active:scale-95"
            >
